 ...
 * Date: 31/01/2016
 */
public class GroupException extends AbstractCustomizedException
{
     ...
     */
    public GroupException(int state)
    {
        super(state);
    }
     ...
     */
    public GroupException(int state, String message)
    {
        super(state, message);
    }
     ...
     */
    public GroupException(int state, String message, Throwable cause)
    {
     ...
     * @param cause Throwable object that indicate the cause
     */
    public GroupException(int state, Throwable cause)
    {
        super(state, cause);
    }
     ...
     */
    public GroupException(int state, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
    {
